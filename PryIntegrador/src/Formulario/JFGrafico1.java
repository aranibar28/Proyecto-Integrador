package Formulario;
public class JFGrafico1 extends javax.swing.JFrame {
    public JFGrafico1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lvfinal = new javax.swing.JLabel();
        ...
        getContentPane().add(ltiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, -1, -1));

        lvfinal.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        lvfinal.setForeground(new java.awt.Color(255, 0, 0));
        lvfinal.setText("vf");
        getContentPane().add(lvfinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 190, -1, -1));
        ...
        getContentPane().add(laltura, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, -1, -1));

        lalcance.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        lalcance.setForeground(new java.awt.Color(255, 0, 0));
        lalcance.setText("alcance");
        getContentPane().add(lalcance, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, -1, -1));
        ...
        getContentPane().add(lvinicial, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, -1, -1));
        ...
        getContentPane().add(langulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, -1, -1));

        jLabel1.setFont(new java.awt.Font("Trebuchet MS", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 204, 204));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Grafica1.jpg"))); // NOI18N
    ...
    String angulo,vinicial,altura,alcance,tiempo,vfinal;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFGrafico1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFGrafico1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lvfinal;
